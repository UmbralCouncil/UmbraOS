# UmbraOS live/installer ISO — the graphical Niri image users boot to try
...
#
# The shared Niri module owns the compositor, SDDM, and lightweight desktop
...
{
  imports = [
    # NixOS graphical live base. Umbra supplies Niri and its own installer;
